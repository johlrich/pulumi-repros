...
__ServiceStateProvider_instance.create = __f3;
...
function __ServiceStateProvider() {
  return (function() {
    with({ __awaiter: __f1, __generator: __f2, ServiceStateProvider: __ServiceStateProvider }) {
...
function __f3() {
  return (function() {
    with({ __awaiter: __f1, _this: __ServiceStateProvider_instance, __generator: __f2 }) {
